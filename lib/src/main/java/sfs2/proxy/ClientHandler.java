/* ClientHandler.java
 * 
 * This file is the main proxy functionality. It receives data from a socket and forwards
    ...
    public void run() {
        ...
        try {
            while ((headerByte = socketIn.read()) != -1) {
                ...
                // Used to write decoded data to file
                try {
                decode(inputBuf, handler);
                } catch (Exception e) {
                	logger.log(Level.SEVERE, "Error decoding request sent with proxy");
